  ...
  return (
    <EditableSiteShell>
      <main className="bg-[#f7f4ef] text-[#111]">
        <section className="border-b border-[#541A1A] bg-[#810B38] text-[#F1E2D1]">
        ...
        <section className="mx-auto grid max-w-[var(--editable-container)] border-x border-black bg-white lg:grid-cols-[1.45fr_0.55fr]">
          <article className="border-b border-black p-7 sm:p-10 lg:border-b-0 lg:border-r lg:p-16">
            <p className="text-sm font-black uppercase tracking-[0.2em] text-[#810B38]">About {SITE_CONFIG.name}</p>
          ...
          <aside className="grid bg-[#f7f4ef]">
            {pagesContent.about.values.map((value, index) => (
              <div key={value.title} className="border-b border-black p-7 last:border-b-0 sm:p-9">
                <p className="text-xs font-black uppercase tracking-[0.2em] text-[#810B38]">0{index + 1}</p>
        ...
        <section className="border-y border-[#541A1A] bg-[#541A1A] text-[#F1E2D1]">
          <div className="mx-auto flex max-w-[var(--editable-container)] flex-col gap-6 px-4 py-12 sm:px-6 lg:flex-row lg:items-center lg:justify-between lg:px-8">
            ...
            <Link href="/search" className="inline-flex w-fit bg-[#810B38] px-6 py-4 text-xs font-black uppercase tracking-[0.18em] text-[#F1E2D1]">Explore the archive</Link>
          </div>
        </section>
      </main>
    </EditableSiteShell>
